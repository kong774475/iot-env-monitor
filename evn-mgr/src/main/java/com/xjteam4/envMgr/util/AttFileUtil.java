...
public class AttFileUtil {
	 ...
	 */
	public static byte[] resizeImage(MultipartFile originalFile, int maxWidth, int maxHeight) throws IOException {
		// 读取原始图片
		...
		String formatName = originalFile.getContentType().contains("png") ? "png" : "jpg";
